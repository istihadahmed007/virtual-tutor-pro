...
import { ArrowRight, Loader2, Mail, UserX, GraduationCap, BookOpen } from "lucide-react";
              ...
              <>
                <CardHeader className="text-center">
                  <div className="flex justify-center">
                    <img src={logo} alt="LiveClass" width={56} height={56} className="rounded-xl mb-4 mt-4 cursor-pointer" onClick={() => navigate("/")} />
                  </div>
                ...
                <CardContent className="pb-6">
                  <div className="space-y-3">
                    <button onClick={() => handleRoleSelect("student")} className="w-full p-4 rounded-xl border-2 border-stone-200 hover:border-teal-300 hover:bg-teal-50/50 transition-all text-left group">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-bold text-slate-900">I want to Learn</p>
                          <p className="text-xs text-slate-500">Find teachers and book live classes</p>
                        </div>
                        <ArrowRight className="w-4 h-4 text-slate-400 ml-auto group-hover:text-teal-600 transition-colors" />
                      </div>
                    </button>
                    <button onClick={() => handleRoleSelect("teacher")} className="w-full p-4 rounded-xl border-2 border-stone-200 hover:border-indigo-300 hover:bg-indigo-50/50 transition-all text-left group">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-bold text-slate-900">I want to Teach</p>
                          <p className="text-xs text-slate-500">Share your expertise and earn</p>
                        </div>
                ...
                <form onSubmit={handleOtpSubmit}>
                  <CardContent className="pb-4">
                    ...
                    <p className="text-sm text-muted-foreground text-center mt-4">
                      ...
                      <Button variant="link" className="p-0 h-auto" onClick={() => setStep("signIn")}>Try again</Button>
                    </p>
                  </CardContent>
                  <CardFooter className="flex-col gap-2">
                    ...
                    <Button type="button" variant="ghost" onClick={() => setStep("signIn")} disabled={isLoading} className="w-full">Use different email</Button>
                  </CardFooter>
                </form>
              </>
            )}
