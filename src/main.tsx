...
> {
  ...
  componentDidCatch(err: Error) {
    console.error("[RootErrorBoundary] Caught error:", err);
  }
  render() {
    if (this.state.hasError) {
      return (
        <div className="min-h-screen flex items-center justify-center bg-[#FAFAF8] text-slate-900 p-6">
          <div className="max-w-lg text-center">
            ...
            <button
              ...
              className="mt-4 px-4 py-2 bg-slate-900 text-white text-sm rounded-lg"
            >
              Reload page
            </button>
          </div>
...
const CONVEX_URL = import.meta.env.VITE_CONVEX_URL || "https://determined-jellyfish-610.convex.cloud";
