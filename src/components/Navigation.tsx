...
const navLinks = [
  ...
  { label: "Live Classes", path: "/classes", icon: Video },
  { label: "Community", path: "/community", icon: BookOpen },
          ...
          <div className="flex items-center gap-3">
            {isAuthenticated ? (
                    ...
                    <>
                      ...
                      <div className="absolute right-0 top-full mt-2 w-56 bg-white rounded-xl shadow-xl border border-stone-200 py-2 z-50">
                        <button
                          ...
                          className="w-full px-4 py-2.5 text-left text-sm text-slate-700 hover:bg-stone-50 flex items-center gap-2.5"
                        >
              ...
              <div className="flex items-center gap-2">
                <Button variant="ghost" size="sm" onClick={() => navigate("/auth")} className="text-slate-600">
                  Sign In
                </Button>
                <Button size="sm" onClick={() => navigate("/auth")} className="bg-teal-600 hover:bg-teal-700 text-white">
                  Get Started
                </Button>
              </div>
            )}
